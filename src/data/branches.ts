...
export const branches: Branch[] = [
  ...
  },
  {
    ...
    longDescription:
      "Syel Agroalimentaire a été lancée en 2014 pour répondre au défi de la transformation locale des matières premières agricoles en RDC. Implantée à Lubumbashi, au cœur du bassin agricole du Katanga, la filiale exploite deux unités de transformation : une usine de torréfaction et d'emballage de café d'une capacité de 5 000 tonnes par an, et une unité de transformation de manioc en farine et amidon. Syel Agroalimentaire travaille en partenariat avec plus de 3 000 agriculteurs organisés en coopératives au Kivu et au Katanga, leur garantissant des prix d'achat stables et un accès à des intrants de qualité. La marque « Saveurs du Terroir » est désormais distribuée dans les principales villes de la RDC. En 2025, la filiale a inauguré une nouvelle ligne de production d'huile de palme raffinée certifiée durable (RSPO), positionnant le Groupe Syel comme un acteur responsable de l'agro-industrie congolaise. L'effectif atteint 480 employés permanents et plus de 200 saisonniers.",
    established: "2014",
    memberCount: 480,
    projectCount: 24,
    image:
