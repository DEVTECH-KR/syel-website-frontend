...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      "Le Programme d'Électrification Rurale du Kivu est le plus grand projet d'accès à l'énergie jamais entrepris par Syel Energy en RDC. Financé par la Banque Mondiale et l'Agence Française de Développement, ce programme vise à installer des mini-réseaux solaires hybrides (solaire + batteries + groupes diesel de secours) dans 120 villages isolés où le taux d'accès à l'électricité est inférieur à 5 %. Chaque mini-réseau est dimensionné pour alimenter entre 200 et 500 foyers, ainsi que les infrastructures communautaires (centre de santé, école, pompe à eau). Le modèle économique repose sur un opérateur local formé par Syel Energy, qui assure la maintenance et la collecte des paiements via mobile money. Les 40 premiers villages ont été raccordés en 2025, et le programme s'achèvera en 2027. L'impact attendu est transformationnel : accès à la lumière, conservation des médicaments, irrigation, accès à l'information et développement d'activités économiques nocturnes.",
    impact:
